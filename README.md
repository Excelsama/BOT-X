...
## Deployment Methods
---
1. ***Get [`SESSION ID 1`](https://replit.com/@Bladeh4x/BLADE-MD-V1?v=1)[`SESSION ID 2`](https://replit.com/@Bladeh4x/BLADE-MD-V2-1?v=1)  by scanning QR code. `Whatapp>Three dots>Linked Devices`***
##
