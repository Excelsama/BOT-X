...
if (fs.existsSync('./config-menu/' + Config.LANG + '.json')) {var json = JSON.parse(fs.readFileSync('./config-menu/' + Config.LANG + '.json'));        } 
else { var json = JSON.parse(fs.readFileSync('./config-menu/BOT-X.json'));}        
