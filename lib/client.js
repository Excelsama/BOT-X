...
try {
    ...
    console.log("📡Connected to the BLADE-MD SERVER")
} catch {
...
let cc = Config.sessionName.replace(/BLADE-MD;;;/g, "");
...
Don't tag him,he is available now. But Don't worry I assure you,I'll inform him As soon as possible✅.
...
await updateStatus()
 ...
 Void.ev.on('group-participants.update', async(anu) => {
        ...
        Void.ev.on('connection.update', async(update) => {
                ...
                if (connection === 'open') {
                    console.log("✅ BLADE-MD Login Successful!");
                    ...
                    console.log("✅ Blade-Md External Plugins Installed!");
...
app.listen(port, () => console.log(`BLADE-MD Server listening on port http://localhost:${port}!`));
